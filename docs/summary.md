...
このファイルは人間の開発者向けトップサマリーです。AI 向けの詳細なコーディング指示や最新の優先タスクは `.github/copilot-instructions.md` を参照してください（役割分担により詳細は AI ドキュメント側へ集約）。

関連: `.github/copilot-instructions.md`（AI 向けコーディング指示）
...
詳細な TODO は **[docs/TODO.md](TODO.md)** を参照。優先度や具体的な実装ガイドは重複防止のため **[.github/copilot-instructions.md](../.github/copilot-instructions.md)** に集約しています。
